...
<nav class="navbar navbar-default navbar-static-top" role="navigation"
	...
	<div class="navbar-header">
		...
		<a class="navbar-brand" href="dashboard.html">ILM</a>
	</div>
	<!-- /.navbar-header -->
		...
		<li class="dropdown"><a class="dropdown-toggle"
			...
			<ul class="dropdown-menu dropdown-tasks">
				<li><a href="#">
						<div>
							<p>
								<strong>分析1</strong> <span class="pull-right text-muted">40%
									Complete</span>
							</p>
				...
				<li><a href="#">
						<div>
							<p>
								<strong>分析2</strong> <span class="pull-right text-muted">20%
									Complete</span>
							</p>
							<div class="progress progress-striped active">
				...
				<li><a href="#">
						<div>
							<p>
								<strong>分析 3</strong> <span class="pull-right text-muted">60%
									Complete</span>
							</p>
							<div class="progress progress-striped active">
				...
				<li><a href="#">
						<div>
							<p>
								<strong>分析 4</strong> <span class="pull-right text-muted">80%
									Complete</span>
							</p>
							<div class="progress progress-striped active">
